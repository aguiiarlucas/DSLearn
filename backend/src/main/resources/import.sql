...
INSERT INTO tb_user (name, email, password) VALUES ('Bob Toddy', 'bob@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');
INSERT INTO tb_user (name, email, password) VALUES ('Maria Green', 'maria@gmail.com', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG');

INSERT INTO tb_role (authority) VALUES ('ROLE_STUDENT');
INSERT INTO tb_role (authority) VALUES ('INSTRUCTOR');
...
INSERT INTO tb_resource(title, description, position, img_Uri, type, offer_id) VALUES ('Lives','Lives exclusivas para turma', 3,'https://cdn.pixabay.com/photo/2018/03/22/10/55/training-course-3250007_1280.jpg',0, 1);
...
INSERT INTO tb_content(id, text_Content, video_Uri) VALUES(1,'Mat.apoio ','https://youtu.be/sqbqoR-lMf8');

INSERT INTO tb_lesson(title, position , section_id) VALUES('Aula 1 do  cap 1', 2 ,1);
...
INSERT INTO tb_task(id, description, question_Count, approval_Count, weight, due_Date)VALUES(4,'Fazer um trabalho legal',5,3,1.0,TIMESTAMP WITH TIME ZONE '2020-12-25T13:00:00Z');
